package io.ihankun.framework.poi.pdf.fop;

import lombok.SneakyThrows;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import io.ihankun.framework.poi.pdf.fop.datasource.XEasyPdfTemplateDataSource;
    ...
    public io.ihankun.framework.poi.pdf.pdfbox.doc.XEasyPdfDocument transform() {
        ...
        try (ByteArrayOutputStream outputStream = new ByteArrayOutputStream()) {
            ...
            try (InputStream inputStream = new BufferedInputStream(new ByteArrayInputStream(outputStream.toByteArray()))) {
                // 加载pdf并返回
                return io.ihankun.framework.poi.pdf.pdfbox.handler.XEasyPdfHandler.Document.load(inputStream);
            }
        }
    }
