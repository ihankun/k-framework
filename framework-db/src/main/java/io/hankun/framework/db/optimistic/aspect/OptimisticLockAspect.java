package io.hankun.framework.db.optimistic.aspect;

import io.hankun.framework.core.exception.BusinessException;
import io.hankun.framework.core.optimistic.Lock;
import io.hankun.framework.core.optimistic.LockId;
import io.hankun.framework.core.optimistic.LockParam;
import io.hankun.framework.core.optimistic.LockVersion;
import io.hankun.framework.db.error.CommonDbErrorCode;
import io.hankun.framework.db.optimistic.dao.OptimisticLockMapper;
...
public class OptimisticLockAspect {
    ...
    @Pointcut("@annotation(io.hankun.framework.core.optimistic.Lock)")
