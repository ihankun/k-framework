package io.hankun.framework.job.dynamic.service;
...
import io.hankun.framework.job.base.JobAttributeTag;
import io.hankun.framework.job.config.JobConfig;
import io.hankun.framework.job.dynamic.JsonUtils;
import io.hankun.framework.job.dynamic.bean.Job;
        ...
        if (config.isGrayActive()) {
            switch (jobStrategyClass) {
                case "com.dangdang.ddframe.job.lite.api.strategy.impl.OdevitySortByNameJobShardingStrategy":
                    jobStrategyClass = "io.hankun.framework.job.strategy.SortByNameShardingGrayStrategy";
                    break;
                case "com.dangdang.ddframe.job.lite.api.strategy.impl.RotateServerByNameJobShardingStrategy":
                    jobStrategyClass = "io.hankun.framework.job.strategy.RotateByNameShardingStrategy";
                    break;
                default:
                    jobStrategyClass = "io.hankun.framework.job.strategy.AverageShardingGrayStrategy";
                    break;
            }
