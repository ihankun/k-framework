package io.hankun.framework.mongoplus.conditions.interfaces.aggregate;
...
import io.hankun.framework.mongoplus.conditions.interfaces.Project;
...
import io.hankun.framework.mongoplus.enums.GroupTypeEnum;
...
public interface Aggregate<T,Children> extends Project<T,Children> {
    ...
    */
     ...
     * @param operator 操作，参考{@link io.hankun.framework.mongoplus.enums.GroupTypeEnum}枚举
     * @param field 列名、字段名
     * @return Children
     * @author hankun
