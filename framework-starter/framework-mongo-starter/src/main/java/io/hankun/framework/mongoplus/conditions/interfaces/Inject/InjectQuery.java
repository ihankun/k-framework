package io.hankun.framework.mongoplus.conditions.interfaces.Inject;
...
public interface InjectQuery extends CommInjectQuery {
    ...
    */
    ...
    /**
     * 获取单个，返回T类型的对象
     * <p style="color:red">注：如果查询到大于一条数据，会抛出{@link io.hankun.framework.mongoplus.domain.MongoQueryException}异常</p>
     * @param collectionName 集合名
