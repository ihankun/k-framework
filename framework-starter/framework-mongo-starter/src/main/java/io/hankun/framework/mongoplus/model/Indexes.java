package io.hankun.framework.mongoplus.model;
...
public final class Indexes {
     ...
     * @return 索引详述
     * @deprecated geoHaystack 在 MongoDB 4.4 中已弃用，首选 {@link io.hankun.framework.mongoplus.model.Indexes#geo2dsphere(String...)}
     */
    @Deprecated
