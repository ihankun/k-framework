package io.hankun.framework.mongoplus.execute;

import io.hankun.framework.mongoplus.annotation.ID;
import io.hankun.framework.mongoplus.annotation.collection.CollectionName;
import io.hankun.framework.mongoplus.cache.global.HandlerCache;
...
import io.hankun.framework.mongoplus.conditions.interfaces.condition.Order;
import io.hankun.framework.mongoplus.conn.ConnectMongoDB;
import io.hankun.framework.mongoplus.constant.SqlOperationConstant;
import io.hankun.framework.mongoplus.context.MongoTransactionContext;
import io.hankun.framework.mongoplus.convert.CollectionNameConvert;
import io.hankun.framework.mongoplus.convert.Converter;
import io.hankun.framework.mongoplus.convert.DocumentMapperConvert;
import io.hankun.framework.mongoplus.domain.InitMongoCollectionException;
import io.hankun.framework.mongoplus.domain.MongoQueryException;
import io.hankun.framework.mongoplus.enums.AggregateOptionsEnum;
import io.hankun.framework.mongoplus.enums.IdTypeEnum;
import io.hankun.framework.mongoplus.enums.QueryOperatorEnum;
import io.hankun.framework.mongoplus.enums.SpecialConditionEnum;
import io.hankun.framework.mongoplus.model.*;
import io.hankun.framework.mongoplus.strategy.convert.ConversionService;
import io.hankun.framework.mongoplus.support.SFunction;
import io.hankun.framework.mongoplus.toolkit.*;
import io.hankun.framework.mongoplus.toolkit.codec.RegisterCodecUtil;
...
import static io.hankun.framework.mongoplus.toolkit.BeanMapUtilByReflect.getIdField;

/**
 * @Description: sql执行
 * @BelongsProject: mongo
 * @BelongsPackage: io.hankun.framework.mongoplus.sql
 * @Author: hankun
