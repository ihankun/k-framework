package io.hankun.framework.pdf.fop.doc.component.table;

import io.hankun.framework.pdf.fop.XEasyPdfTemplateAttributes;
import io.hankun.framework.pdf.fop.doc.component.XEasyPdfTemplateComponent;
import io.hankun.framework.pdf.fop.handler.XEasyPdfTemplateElementHandler;
...
public class XEasyPdfTemplateTable implements XEasyPdfTemplateComponent {
    ...
    private Element createTable(Document document) {
        ...
        // 设置字体颜色
        Optional.ofNullable(this.param.getColor()).ifPresent(v -> table.setAttribute(XEasyPdfTemplateAttributes.COLOR, v.intern().toLowerCase()));
        // 设置行间距
