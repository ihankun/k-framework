...
import io.hankun.framework.core.utils.plus.ResourceUtil;
import io.hankun.framework.core.utils.string.StringUtil;
import io.hankun.framework.nat.core.DefaultNatsTemplate;
import io.hankun.framework.nat.core.NatsListenerDetector;
import io.hankun.framework.nat.core.NatsTemplate;
...
public class NatsConfiguration {
    ...
    private static KeyManager[] createKeyManagers(String path, String passwordStr,
        ...
        if (StringUtil.isBlank(keyStoreType)) {
            keyStoreType = "PKCS12";
        }
        char[] password;
