...
import io.hankun.framework.log.constant.TraceLogConstant;
import io.hankun.framework.log.context.TraceLogContext;
import io.hankun.framework.log.enums.LogTypeEnum;
import io.hankun.framework.mq.MqAutoConfiguration;
import io.hankun.framework.mq.config.GrayMark;
import io.hankun.framework.mq.config.MqProperties;
import io.hankun.framework.mq.constants.MqSendResult;
import io.hankun.framework.mq.message.MqMsg;
import io.hankun.framework.mq.producer.IMqProducer;
import io.hankun.framework.mq.producer.MqSendCallback;
import io.hankun.framework.mq.producer.MqTopic;
import io.hankun.framework.mq.producer.bean.TopicConfigInfo;
import io.hankun.framework.mq.rocketmq.RocketMqAdmin;
import io.hankun.framework.mq.rocketmq.producer.strategy.impl.GgrayProducerSelectQueueStrategy;
import io.hankun.framework.mq.rocketmq.producer.strategy.impl.GrayProducerSelectQueueStrategy;
import io.hankun.framework.mq.rocketmq.producer.strategy.impl.ProdProducerSelectQueueStrategy;
import io.hankun.framework.mq.rule.MqAccessRule;
...
public class RocketMqProducer implements IMqProducer {
    ...
    public void start(MqProperties config) {
        ...
        producer = new io.hankun.framework.mq.rocketmq.producer.MqProducer(producerGroupName, mqFaultStrategy, null, grayMark);
