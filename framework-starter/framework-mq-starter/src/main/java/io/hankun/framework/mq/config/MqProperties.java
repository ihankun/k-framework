package io.hankun.framework.mq.config;
...
public class MqProperties {
     ...
     */
    private String allocateQueueStrategy = "com.hankun.core.mq.rocketmq.consumer.strategy.KunProdAllocateMessageQueueStrategy";
