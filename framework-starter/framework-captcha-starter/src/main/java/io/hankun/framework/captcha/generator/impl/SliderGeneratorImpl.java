package io.hankun.framework.captcha.generator.impl;

import io.hankun.framework.captcha.generator.AbstractGenerator;
import io.hankun.framework.captcha.generator.entity.CaptchaGeneratorVO;
import io.hankun.framework.core.utils.captcha.CaptchaImageUtils;
...
public class SliderGeneratorImpl extends AbstractGenerator {
    ...
    public CaptchaGeneratorVO generator() {
        ...
        try {
            ...
            // 获取随机的 x 和 y 轴
            int randomX = randomInt(fixedTemplate.getWidth() + 10, background.getWidth() - fixedTemplate.getWidth() - 20);
