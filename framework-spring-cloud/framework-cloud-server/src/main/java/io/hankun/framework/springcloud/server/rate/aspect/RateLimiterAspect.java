...
import io.hankun.framework.springcloud.server.rate.annoation.RateLimiterType;
...
public class RateLimiterAspect {
    ...
    @Around("@annotation(io.hankun.framework.springcloud.server.rate.annoation.RateLimiter)")
