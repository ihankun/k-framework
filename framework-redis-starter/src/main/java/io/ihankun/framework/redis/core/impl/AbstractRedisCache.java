...
import io.ihankun.framework.redis.enums.RedisSizeControlMode;
import io.ihankun.framework.redis.holder.RedisTemplateHolder;
...
import static io.ihankun.framework.redis.error.CacheErrorCodeEnum.*;
