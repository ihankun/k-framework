package io.ihankun.framework.mongoplus.execute;

import io.ihankun.framework.mongoplus.annotation.ID;
import io.ihankun.framework.mongoplus.annotation.collection.CollectionName;
...
import io.ihankun.framework.mongoplus.conn.ConnectMongoDB;
...
import io.ihankun.framework.mongoplus.convert.Converter;
import io.ihankun.framework.mongoplus.convert.DocumentMapperConvert;
import io.ihankun.framework.mongoplus.domain.InitMongoCollectionException;
import io.ihankun.framework.mongoplus.domain.MongoQueryException;
import io.ihankun.framework.mongoplus.enums.AggregateOptionsEnum;
import io.ihankun.framework.mongoplus.enums.IdTypeEnum;
import io.ihankun.framework.mongoplus.enums.QueryOperatorEnum;
import io.ihankun.framework.mongoplus.enums.SpecialConditionEnum;
import io.ihankun.framework.mongoplus.model.*;
...
import io.ihankun.framework.mongoplus.toolkit.*;
import io.ihankun.framework.mongoplus.toolkit.codec.RegisterCodecUtil;
...
import static io.ihankun.framework.mongoplus.toolkit.BeanMapUtilByReflect.getIdField;

/**
 * @Description: sql执行
 * @BelongsProject: mongo
 * @BelongsPackage: io.ihankun.framework.mongoplus.sql
 * @Author: hankun
