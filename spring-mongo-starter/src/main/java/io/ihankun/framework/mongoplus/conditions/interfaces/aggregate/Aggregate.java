package io.ihankun.framework.mongoplus.conditions.interfaces.aggregate;
...
import io.ihankun.framework.mongoplus.conditions.interfaces.Project;
import io.ihankun.framework.mongoplus.conditions.interfaces.aggregate.pipeline.AddFields;
import io.ihankun.framework.mongoplus.conditions.interfaces.aggregate.pipeline.Let;
...
import io.ihankun.framework.mongoplus.enums.GroupTypeEnum;
import io.ihankun.framework.mongoplus.model.FuncGroupField;
...
public interface Aggregate<T,Children> extends Project<T,Children> {
    ...
    */
     ...
     * @param operator 操作，参考{@link io.ihankun.framework.mongoplus.enums.GroupTypeEnum}枚举
     * @param field 列名、字段名
     * @return Children
     * @author hankun
