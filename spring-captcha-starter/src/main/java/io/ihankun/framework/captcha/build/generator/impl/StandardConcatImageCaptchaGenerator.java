package io.ihankun.framework.captcha.build.generator.impl;

import io.ihankun.framework.captcha.build.generator.AbstractImageCaptchaGenerator;
import io.ihankun.framework.captcha.build.generator.ImageTransform;
import io.ihankun.framework.captcha.build.generator.entity.*;
...
import static io.ihankun.framework.captcha.common.constant.CommonConstant.DEFAULT_SLIDER_IMAGE_RESOURCE_PATH;
import static io.ihankun.framework.captcha.common.constant.CommonConstant.DEFAULT_TAG;
import static io.ihankun.framework.captcha.common.util.CaptchaImageUtils.concatImage;
import static io.ihankun.framework.captcha.common.util.CaptchaImageUtils.splitImage;
