package io.ihankun.framework.captcha.build.validator.impl;

import io.ihankun.framework.captcha.common.response.ApiResponse;
import io.ihankun.framework.captcha.common.response.ApiResponseStatusConstant;
import io.ihankun.framework.captcha.build.generator.entity.ClickImageCheckDefinition;
...
import io.ihankun.framework.captcha.build.validator.SliderCaptchaPercentageValidator;
import io.ihankun.framework.captcha.common.constant.TrackTypeConstant;
import io.ihankun.framework.captcha.build.validator.entity.ImageCaptchaTrack;
import io.ihankun.framework.captcha.common.constant.CaptchaTypeConstant;
import io.ihankun.framework.captcha.common.util.CaptchaTypeClassifier;
import io.ihankun.framework.captcha.common.util.CollectionUtils;
import io.ihankun.framework.captcha.common.util.ObjectUtils;
