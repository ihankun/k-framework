package io.ihankun.framework.captcha.spring.store.impl;

import io.ihankun.framework.captcha.spring.cache.ConCurrentExpiringMap;
import io.ihankun.framework.captcha.spring.cache.ExpiringMap;
