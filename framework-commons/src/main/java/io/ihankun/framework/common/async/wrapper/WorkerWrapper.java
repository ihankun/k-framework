package io.ihankun.framework.common.async.wrapper;

import io.ihankun.framework.common.async.exception.SkippedException;
import io.ihankun.framework.common.async.executor.timer.SystemClock;
import io.ihankun.framework.common.async.callback.DefaultCallback;
import io.ihankun.framework.common.async.callback.ICallback;
import io.ihankun.framework.common.async.callback.IWorker;
import io.ihankun.framework.common.async.worker.DependWrapper;
import io.ihankun.framework.common.async.worker.ResultState;
import io.ihankun.framework.common.async.worker.WorkResult;
