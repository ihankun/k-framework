...
import io.hankun.framework.core.utils.ConvertUtil;
import io.hankun.framework.core.utils.RandomType;
import io.hankun.framework.core.utils.bean.BeanUtil;
import io.hankun.framework.core.utils.date.DateUtil;
import io.hankun.framework.core.utils.encrypt.Base64Util;
import io.hankun.framework.core.utils.encrypt.DigestUtil;
import io.hankun.framework.core.utils.encrypt.HexUtil;
import io.hankun.framework.core.utils.plus.*;
import io.hankun.framework.core.utils.string.Charsets;
...
public class $ {
	 ...
	 * <p>
	 * use: format("my name is ${name}, and i like ${like}!", {"name":"hankun", "like": "Java"})
	 *
	 ...
	 * 同 log 格式的 format 规则
	 * <p>
	 * use: format("my name is {}, and i like {}!", "hankun", "Java")
	 *
	 * @param message   需要转换的字符串
...
//	}
	...
	public static String format(Object object, String pattern) {
		if (object instanceof Number) {
			...
			TemporalAccessor accessor = (TemporalAccessor) object;
