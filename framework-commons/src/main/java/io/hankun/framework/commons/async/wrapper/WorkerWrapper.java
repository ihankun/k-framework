package io.hankun.framework.commons.async.wrapper;

import io.hankun.framework.commons.async.callback.IWorker;
import io.hankun.framework.core.exception.SkippedException;
import io.hankun.framework.commons.async.executor.timer.SystemClock;
import io.hankun.framework.commons.async.callback.DefaultCallback;
import io.hankun.framework.commons.async.callback.ICallback;
import io.hankun.framework.commons.async.worker.DependWrapper;
import io.hankun.framework.commons.async.worker.ResultState;
import io.hankun.framework.commons.async.worker.WorkResult;
