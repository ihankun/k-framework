...
import io.hankun.framework.cache.config.RedisSizeProperties;
import io.hankun.framework.cache.enums.RedisDataType;
import io.hankun.framework.cache.enums.RedisSizeControlMode;
import io.hankun.framework.cache.holder.RedisTemplateHolder;
...
import static io.hankun.framework.cache.error.CacheErrorCodeEnum.*;
