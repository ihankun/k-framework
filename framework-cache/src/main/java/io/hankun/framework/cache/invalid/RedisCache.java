...
//
//import io.hankun.framework.commons.utils.JsonUtil;
//import io.hankun.framework.cache.key.CacheKey;
//import io.hankun.framework.core.utils.plus.CollectionUtil;
...
//	 */
//	public static RedisCache use(RedisTemplate<String, Object> redisTemplate) {
...
//	 */
//	@Nullable
//	public Long bitCount(String key, long start, long end, io.hankun.framework.redis.enums.RedisCommand.BitMapModel model) {
//		return redisTemplate.execute((RedisCallback<Long>) redis ->
//			(Long) redis.execute(io.hankun.framework.redis.enums.RedisCommand.BITCOUNT, keySerialize(key),
