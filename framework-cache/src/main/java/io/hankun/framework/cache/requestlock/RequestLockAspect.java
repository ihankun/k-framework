...
import io.hankun.framework.cache.CacheBuilder;
import io.hankun.framework.cache.CacheManager;
import io.hankun.framework.cache.key.ICacheKey;
import io.hankun.framework.cache.key.impl.OrgCacheKey;
...
public class RequestLockAspect implements BaseService, Ordered, PriorityOrdered {
    ...
    @Pointcut("@annotation(redis.requestlock.RequestLock)")
