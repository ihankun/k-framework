...
import io.hankun.framework.ai.tools.toolcall.MsunToolCallingManager;
...
public class ToolCallingInterceptChain {
    ...
    private final MsunToolCallingManager manager;

    private final int index;

    public ToolCallingInterceptChain(List<ToolCallingInterceptor> interceptors,
                                     MsunToolCallingManager manager, int index) {
