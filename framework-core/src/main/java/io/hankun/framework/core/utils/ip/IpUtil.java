package io.hankun.framework.core.utils.ip;

import com.alibaba.fastjson.JSON;
import io.hankun.framework.core.exception.HostException;
...
public final class IpUtil {
     ...
     * 是否跳过docker网卡
     */
    private static final String SKIP_DOCKER_ENV = "hankun.skip.docker";
    ...
    public static String getIp() {
        ...
        if (!StringUtils.isEmpty(skipDockerEnv)) {
            try {
                ...
                log.warn("env hankun.skip.parse failed,", e);
            }
        }
