package io.hankun.framework.springboot.filter;
...
@Slf4j
@Component
public class KCorsFilter implements Filter, ApplicationContextAware {
    ...
    private static final String KEY_CORS = "hankun.spring.cors";
