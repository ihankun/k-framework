package io.ihankun.framework.common.v1.utils.bean;


import io.ihankun.framework.common.v1.beans.BeanCopier;
import io.ihankun.framework.common.v1.beans.BeanMap;
import io.ihankun.framework.common.v1.convert.ClassConverter;
import io.ihankun.framework.common.v1.exception.ServiceException;
...
public class BeanUtil extends BeanUtils {
	...
	public static <T> T copyWithConvert(@Nullable Object source, Class<?> sourceClazz, Class<T> targetClazz) {
		...
		T to = newInstance(targetClazz);
		copier.copy(source, to, new ClassConverter(sourceClazz, targetClazz));
		return to;
	}
