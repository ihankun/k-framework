package io.ihankun.framework.common.v1.async.wrapper;

import io.ihankun.framework.common.v1.async.callback.DefaultCallback;
import io.ihankun.framework.common.v1.async.callback.ICallback;
import io.ihankun.framework.common.v1.async.callback.IWorker;
import io.ihankun.framework.common.v1.async.exception.SkippedException;
import io.ihankun.framework.common.v1.async.executor.timer.SystemClock;
import io.ihankun.framework.common.v1.async.worker.DependWrapper;
import io.ihankun.framework.common.v1.async.worker.ResultState;
